...
select *
  ...
  update producto
   set
   pr_imagen = 'https://cdnx.jumpseller.com/gti-electronica/image/46568470/resize/640/640?1710535657'
 where pr_id = 1;
update producto
   set
   pr_imagen = 'https://media.falabella.com/falabellaCL/17187837_1/w=1200,h=1200,fit=pad'
 where pr_id = 2;
update producto
   set
   pr_imagen = 'https://media.falabella.com/falabellaCL/142507704_01/w=1200,h=1200,fit=pad'
 where pr_id = 3;
update producto
   set
   pr_imagen = 'https://media.falabella.com/tottusCL/21348728_1/w=1200,h=1200,fit=pad'
 where pr_id = 4;
update producto
   set
   pr_imagen = 'https://media.falabella.com/falabellaCL/143699098_01/w=1200,h=1200,fit=pad'
 where pr_id = 5;
update producto
   set
   pr_imagen = 'https://media.falabella.com/falabellaCL/124497242_01/w=1200,h=1200,fit=pad'
 where pr_id = 6;
update producto
   set
   pr_imagen = 'https://media.falabella.com/falabellaCL/124704041_01/w=1200,h=1200,fit=pad'
 where pr_id = 7;

update producto
   set
   pr_imagen = 'https://media.falabella.com/falabellaCL/883308468_1/w=1200,h=1200,fit=pad'
 where pr_id = 8;

update producto
   set
   pr_imagen = 'https://media.falabella.com/falabellaCL/140246600_01/w=1200,h=1200,fit=pad'
 where pr_id = 9;

update producto
   set
   pr_imagen = 'https://media.falabella.com/falabellaCL/139929978_01/w=1200,h=1200,fit=pad'
 where pr_id = 10;

update producto
   set
   pr_imagen = 'https://media.falabella.com/falabellaCL/147743462_01/w=1200,h=1200,fit=pad'
 where pr_id = 11;

update producto
   set
   pr_imagen = 'https://media.falabella.com/falabellaCL/113065012_01/w=1200,h=1200,fit=pad'
 where pr_id = 12;

update producto
   set
   pr_nombre = 'Reloj Jaguar'
 where pr_id = 12;
